        ...
        <div class="">
            ...
            <div class="form-section">
                ...
                <div class=" mx-auto justify-center flex flex-wrap gap-[32px]">
                    ...
                    <div
                        class=" bg-white border-[1px] hover:border-[#EE7900] custom-question rounded-[24px] p-1 inline-block layout ordal-quest">
                        <img class=" justify-center mx-auto mt-quest"
                            src=" {{ asset('static/website/images/question1/ques1a.png') }}" alt="">
                        <div class=" mx-auto mt-[16px]">
            ...
            <div class="form-section">
                ...
                <div class=" mx-auto justify-center flex flex-wrap gap-[32px]">
                    <div
                        class=" bg-white border-[1px] border-[#EE7900] custom-question rounded-[24px] p-1 inline-block layout ordal-quest">
                        <img class=" justify-center mx-auto mt-quest"
                ...
                <div class=" mx-auto justify-center flex flex-wrap gap-[32px]">
                    ...
                    <div
                        ...
                        <div class=" mx-auto mt-[1px] justify-center">
                            <h2 class="text-[#1F2937] text-[16px] weigth-2 text-center">Back up againts blackout</h2>
                        </div>
                    </div>
                    <div
                        class=" bg-white border-[1px] hover:border-[#EE7900] custom-question rounded-[24px] p-1 inline-block layout ordal-quest">
                        <img class=" justify-center mx-auto mt-[40px]"
                            src=" {{ asset('static/website/images/question4/ques-4-4-4.png') }}" alt="">
            ...
            <div class="form-section">
                ...
                <div class=" mx-auto justify-center flex flex-wrap gap-[32px]">
                    ...
                    <div
                        class=" bg-white border-[1px] hover:border-[#EE7900] custom-question rounded-[24px] p-1 ordal-quest inline-block layout">
                        <img class=" justify-center mx-auto mt-quest"
                            src=" {{ asset('static/website/images/question5/ques-5-5-5.png') }}" alt="">
                        <div class=" mx-auto mt-[1px]">
                    ...
                    <div
                        class=" bg-white border-[1px] hover:border-[#EE7900] custom-question rounded-[24px] p-1 ordal-quest inline-block layout">
                        <img class=" justify-center mx-auto mt-quest"
                            src=" {{ asset('static/website/images/question5/ques-5-5-5-5.png') }}" alt="">
                        <div class=" mx-auto mt-[1px]">
            ...
            <div class="form-section">
                ...
                <div class=" mx-auto justify-center flex flex-wrap gap-[32px]">
                    <div
                        class=" bg-white border-[1px] border-[#EE7900] custom-question rounded-[24px] p-1 ordal-quest inline-block layout">
                        <img class=" justify-center mx-auto mt-quest"
                    ...
                    <div
                        class=" bg-white border-[1px] hover:border-[#EE7900] custom-question rounded-[24px] p-1 inline-block layout ordal-quest">
                        <img class=" justify-center mx-auto mt-quest"
                            src=" {{ asset('static/website/images/question6/ques-6-6-6.png') }}" alt="">
                        <div class=" mx-auto mt-[1px]">
